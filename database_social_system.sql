-- =====================================================
-- SISTEMA SOCIAL PARA VECIMARKET
...
-- Insertar algunos tipos de publicación de ejemplo
-- INSERT INTO tipos_publicacion (nombre, descripcion) VALUES 
-- ('general', 'Publicación general del negocio'),
-- ('promocion', 'Promoción o oferta especial'),
-- ('producto', 'Publicación relacionada con un producto específico'),
-- ('evento', 'Anuncio de evento o actividad'),
-- ('noticia', 'Noticia o actualización del negocio');
...
-- 1. Asegúrate de que las tablas usuarios, negocios y productos existan antes de ejecutar este script
-- 2. Los triggers se ejecutarán automáticamente para mantener las fechas actualizadas
-- 3. Las vistas facilitan las consultas más comunes del feed social
-- 4. Los índices mejoran el rendimiento de las consultas
-- 5. Las políticas RLS aseguran que solo usuarios autorizados puedan crear publicaciones
